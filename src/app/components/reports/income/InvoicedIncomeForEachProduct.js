...
export default class InvoicedIncomeForEachProduct extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            report: [],
        ...
        this.loadEachProductIncome = this.loadEachProductIncome.bind(this);
    }

    componentDidMount() {
        this.loadEachProductIncome();
    }
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (this.props.startDate != newProps.startDate || this.props.endDate != newProps.endDate ||this.props.products!=newProps.products || this.props.income_type!=newProps.income_type
            ...
            this.setState({
                ...
                that.loadEachProductIncome();
            })
    }

    loadEachProductIncome() {
        const that = this;
        that.setState({
            loading: true
        })
