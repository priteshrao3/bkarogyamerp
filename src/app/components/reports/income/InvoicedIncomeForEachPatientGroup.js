...
export default class InvoicedIncomeForEachPatientGroup extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            report: [],
        ...
        this.loadPatientGroupsIncome = this.loadPatientGroupsIncome.bind(this);
    }

    componentDidMount() {
        this.loadPatientGroupsIncome();
    }
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (this.props.startDate != newProps.startDate || this.props.endDate != newProps.endDate ||this.props.products!=newProps.products || this.props.income_type!=newProps.income_type
            ...
            this.setState({
                ...
                that.loadPatientGroupsIncome();
            })
    }

    loadPatientGroupsIncome() {
        const that = this;
        that.setState({
            loading: true
        })
    ...
    render() {
        ...
        return (
<div>
            <h2>Income For Each Patient Group
