...
export default class InvoicedIncomeForEachProcedure extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            report: [],
        ...
        this.loadEachProcedureIncome = this.loadEachProcedureIncome.bind(this);
    }

    componentDidMount() {
        this.loadEachProcedureIncome();
    }
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (this.props.startDate != newProps.startDate || this.props.endDate != newProps.endDate ||this.props.products!=newProps.products || this.props.income_type!=newProps.income_type
            ...
            this.setState({
                ...
                that.loadEachProcedureIncome();
            })
    }

    loadEachProcedureIncome() {
        const that = this;
        that.setState({
            loading: true
        })
