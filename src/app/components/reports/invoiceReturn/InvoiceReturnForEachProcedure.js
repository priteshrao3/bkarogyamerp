...
export default class InvoiceReturnForEachProcedure extends React.Component{
    constructor(props){
        super(props);
        this.state={
            report: [],
        ...
        this.loadEachProcedureInvoiceReturn = this.loadEachProcedureInvoiceReturn.bind(this);
    }

    componentDidMount() {
        this.loadEachProcedureInvoiceReturn();
    }
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (this.props.startDate != newProps.startDate ||
            ...
            this.setState({
                ...
                that.loadEachProcedureInvoiceReturn();
            })
    ...
    loadEachProcedureInvoiceReturn = () =>{
        const that = this;
        this.startLoading();
    ...
    render() {
        ...
        return(
<div>
                <h2>Return Invoice For Each Procedures
