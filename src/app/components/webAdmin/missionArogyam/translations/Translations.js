import {
    MISSION_AROGYAM_TRANSLATIONS_HEAD,
    MISSION_AROGYAM_WEBSITE_LANG_OPTIONS,
    MISSION_AROGYAM_WEBSITE_TRANSLATION_CATEGORY
...
export default class Translations extends React.Component {
    ...
    componentDidMount() {
        let translations = {};
        MISSION_AROGYAM_TRANSLATIONS_HEAD.forEach(function(key) {
    ...
    loadData = () => {
        ...
        let apiParams = {
            category: MISSION_AROGYAM_WEBSITE_TRANSLATION_CATEGORY,
            page_size: 200,
    ...
    render() {
        ...
        const formFields = [
            ...
            {
                label: 'Value',
                type: editOptions && editOptions["title"].includes("Head") ? INPUT_FIELD : QUILL_TEXT_FIELD,
                key: 'body',
        ...
        const defaultFields = [
            ...
            { key: 'category', value: MISSION_AROGYAM_WEBSITE_TRANSLATION_CATEGORY },
            { key: 'title', value: editOptions ? editOptions.title : null },
            { key: 'id', value: editOptions ? editOptions.id : null },
        ];
        return (
            <Card
                title={'Mission Arogyam Website Translations'}
                extra={
                    <Select
                    ...
                    >
                        {MISSION_AROGYAM_WEBSITE_LANG_OPTIONS.map(item => (
