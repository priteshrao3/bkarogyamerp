...
export default class AddContacts extends React.Component {
    ...
    loadData() {
        ...
        getAPI(interpolate(MISSION_SINGLE_CONTACT, [this.props.match.params.id]), successFn, errorFn);
            ...
            editformProp = {
                successFn (data) {
                    ...
                    if (that.props.history){
                        that.props.history.replace('/mission/contact');
                    };
                },
                errorFn () {

                },
                action: interpolate(MISSION_SINGLE_CONTACT, [this.props.match.params.id]),
                method: "put",
...
/>
            ...
            {this.state.redirect && <Redirect to="/mission/contact" />}
</Row>
)
