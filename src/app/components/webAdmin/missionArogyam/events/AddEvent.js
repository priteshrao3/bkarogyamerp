...
export default class AddEvent extends React.Component {
    ...
    loadData() {
        ...
        getAPI(interpolate(MISSION_SINGLE_EVENTS, [this.props.match.params.id]), successFn, errorFn);
            ...
            editformProp = {
                successFn (data) {
                    ...
                    if (that.props.history){
                        that.props.history.replace('/mission/event');
                    };
                },
                errorFn () {

                },
                action: interpolate(MISSION_SINGLE_EVENTS, [this.props.match.params.id]),
                method: "put",
...
/>
            ...
            {this.state.redirect && <Redirect to="/mission/event" />}
</Row>
)
