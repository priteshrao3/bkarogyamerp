...
import {MISSION_BLOG_SLIDER,MISSION_SINGLE_SLIDER} from "../../../../constants/api";
...
export default class SliderImageList extends React.Component {
    ...
    loadData() {
        ...
        getAPI(MISSION_BLOG_SLIDER, successFn, errorFn);
    }
    ...
    deleteObject(record) {
        ...
        patchAPI(interpolate(MISSION_SINGLE_SLIDER, [record.id]), reqData, successFn, errorFn)
    }
...
<div><Switch>
            ...
            <Card
              title="Slider Image"
              extra={(
<Link to="/mission/slider-image/add">
                <Button type="primary">
                    <Icon type="plus" /> Add
                </Button>
</Link>
...
/>
                      ...
                      actions={[<Link to={`/mission/slider-image/edit/${  item.id}`}>Edit</Link>,
                                   <Popconfirm
