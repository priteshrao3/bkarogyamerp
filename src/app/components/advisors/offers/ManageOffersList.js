...
import {displayMessage, getAPI, interpolate, patchAPI, putAPI} from "../../../utils/common";
import AddManageOffers from "./AddManageOffers"
import InfiniteFeedLoaderButton from "../../common/InfiniteFeedLoaderButton";
import {WEB_DYNAMIC_CONTENT, WEB_DYNAMIC_SINGLE_CONTENT} from "../../../constants/api";

export default class ManageOffersList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            offersData: null,
    ...
    render() {
        ...
        const columns = [{
            ...
            render: (item) => {
                return (
                    <div>
                        <Link to={`/erp/advisors/offers/edit/${item.id}`}>Edit</Link>
        ...
        return (
            <div>
                <h2>Schemes & Offers
                    <Link to="/erp/advisors/offers/add">
                ...
                <Switch>
                    <Route
                        ...
                        render={(route) => <AddManageOffers loadData={this.loadData} {...this.state} {...route} />}
                    />
                    <Route
                        exact
